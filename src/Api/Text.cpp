...
Text::Text(const std::string& name, const std::string& tag, int layer, double width, double height, const std::string& text, const std::string& font, int size, Alignment alignment, const Color& color) : UIObject(name, tag, layer, width, height), text{text}, font{font}, size{size}, alignment{alignment}, color{color} {
}
