...
void TestApplyForce::OnUpdate()
{
    if (spic::Input::GetKeyDown(spic::Input::KeyCode::LEFT_CONTROL))
    {
...
void TestApplyForce::OnTriggerEnter2D(const spic::Collider& collider)
{
    BehaviourScript::OnTriggerEnter2D(collider);
}

void TestApplyForce::OnTriggerExit2D(const spic::Collider& collider)
{
    BehaviourScript::OnTriggerExit2D(collider);
}

void TestApplyForce::OnTriggerStay2D(const spic::Collider& collider)
{
